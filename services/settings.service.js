...
const sanitizeOrderReceiptSettings = (payload = {}) => {
  ...
  return {
    ...
    showProductCategories: toBoolean(payload.showProductCategories, defaultOrderReceiptSettings.showProductCategories),
    ...
    settlementPrint: {
      ...
      showOrderGrossSale: toBoolean(settlementPrint.showOrderGrossSale, true),
      showOrderCreditApplied: toBoolean(settlementPrint.showOrderCreditApplied, true),
      showOrderCollectedSale: toBoolean(settlementPrint.showOrderCollectedSale, true),
      showOrderExchange: toBoolean(settlementPrint.showOrderExchange, true),
